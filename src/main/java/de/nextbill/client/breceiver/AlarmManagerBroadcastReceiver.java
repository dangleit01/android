	...
	public void onReceive(Context context, Intent intent) {
        ...
        try{
            ...
            if (appUser != null) {
                ...
                Intent sIntent = new Intent(context, RequestUpdateService.class);
                sIntent.putExtra(RequestUpdateService.KEY_TYPE, RequestUpdateService.REQUEST_TYPE_PATCH_UPDATE);
