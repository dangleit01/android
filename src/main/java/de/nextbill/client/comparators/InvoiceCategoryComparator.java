...
public class InvoiceCategoryComparator implements Comparator<InvoiceCategory>{
    public InvoiceCategoryComparator() {
    }

    @Override
    public int compare(InvoiceCategory invoiceCategory1, InvoiceCategory invoiceCategory2) {

        String bpname1 = invoiceCategory1.getInvoiceCategoryName();
        if (bpname1 != null){
            bpname1 = bpname1.toLowerCase();
        }
        String bpname2 = invoiceCategory2.getInvoiceCategoryName();
        if (bpname2 != null){
